        ...
        class Mecha {
            ...
            private _frameEventHandler(event: EventType): void {
                if (event.eventObject.name == "onFire") {
                    ...
                    (<ArmatureDisplayType>event.eventObject.armature.display).localToGlobal(firePointBone.global.x, firePointBone.global.y, Mecha._globalPoint);
            ...
            public update(): Boolean {
                ...
                if (
                    ...
                    if (this._effect) {
                        ...
                        Game.instance.removeChild(<ArmatureDisplayType>this._effect.display);
