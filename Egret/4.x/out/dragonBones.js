...
(function (dragonBones) {
    ...
    var ArmatureData = (function (_super) {
        ...
        function ArmatureData() {
            ...
            /**
             * The names of all the AnimationData instances for the instance.
             * @version DragonBones 3.0
             * @see dragonBones.AnimationData
             * @language en_US
             */
            /**
             * 该实例所有的 AnimationData 实例名称。
             * @see dragonBones.AnimationData
             * @version DragonBones 3.0
             * @language zh_CN
             */
        ...
        /**
         * Get a specific BoneData instance.
         * @param name The BoneData instance name
        ...
        /**
         * Get a specific SlotData instance.
         * @param name The SlotData instance name
         * @version DragonBones 3.0
        ...
        /**
         * Get a specific SkinData instance.
         * @param name The SkinData instance name
         * @version DragonBones 3.0
        ...
        /**
         * Get a specific AnimationData instance.
         * @param name The AnimationData instance name
         * @version DragonBones 3.0
         * @see dragonBones.AnimationData
         * @language en_US
         */
        /**
         * 获取特定的 AnimationData 实例。
         * @param name AnimationData 实例名称。
         * @version DragonBones 3.0
         * @see dragonBones.AnimationData
         * @language zh_CN
         */
...
(function (dragonBones) {
    /**
     * The skin data. (Typically a ArmatureData instance contains at least one SkinData instance)
     * @version DragonBones 3.0
     * @language en_US
     */
    /**
     * 皮肤数据。（通常一个 ArmatureData 实例至少包含一个 SkinData 实例）
     * @version DragonBones 3.0
     * @language zh_CN
     */
...
(function (dragonBones) {
    ...
    var AnimationData = (function (_super) {
         ...
         * @private
         */
        AnimationData.prototype.getConstraintTimeline = function (name) {
...
(function (dragonBones) {
    ...
    var TransformObject = (function (_super) {
        ...
        Object.defineProperty(TransformObject.prototype, "armature", {
            /**
             * The Armature instance to which it belongs.
        ...
        Object.defineProperty(TransformObject.prototype, "parent", {
            /**
             * The parent bone instance to which it belongs.
             * @see dragonBones.Bone
             * @version DragonBones 3.0
             * @language en_US
             */
...
(function (dragonBones) {
    /**
     * Bone is one of the most important logical units in the skeletal animation system,
     * and is responsible for the realization of translate, rotation, scaling in the animations.
     * A skeleton can contain multiple bones.
     * @see dragonBones.BoneData
     * @see dragonBones.Armature
     * @see dragonBones.Slot
     * @version DragonBones 3.0
        ...
        AnimationState.prototype._updateTimelines = function () {
            ...
            }
            {
                ...
                for (var _j = 0, _k = this._armature.getSlots(); _j < _k.length; _j++) {
                    ...
                    var timelineDatas = this._animationData.getSlotTimeline(timelineName);
                    if (timelineName in slotTimelines) {
                        ...
                        if (this.resetToPose) {
                            ...
                            if (slot.rawDisplayDatas !== null) {
                                for (var _m = 0, _o = slot.rawDisplayDatas; _m < _o.length; _m++) {
                                    ...
                                    if (displayData !== null && displayData.type === 2 /* Mesh */ && ffdFlags.indexOf(meshOffset) < 0) {
                                        var timeline = dragonBones.BaseObject.borrowObject(dragonBones.SlotFFDTimelineState);
            ...
            }
            {
                ...
                for (var _t = 0, _u = this._armature._constraints; _t < _u.length; _t++) {
                    ...
                    var timelineDatas = this._animationData.getConstraintTimeline(timelineName);
                    if (timelineName in constraintTimelines) {
...
(function (dragonBones) {
    ...
    var IKConstraintTimelineState = (function (_super) {
        ...
        IKConstraintTimelineState.prototype.fadeOut = function () {
            this._tweenState = 0 /* None */;
            this._dirty = false;
        };
...
(function (dragonBones) {
    ...
    var BaseFactory = (function () {
         ...
         * @language zh_CN
         */
        BaseFactory.prototype.replaceSkin = function (armature, skin, exclude) {
         ...
         * @language zh_CN
         */
        BaseFactory.prototype.replaceAnimation = function (armature, armatureData) {
                    ...
                    if (display instanceof dragonBones.Armature) {
                        ...
                        if (displayDatas !== null && index < (dragonBones.DragonBones.webAssembly ? displayDatas.size() : displayDatas.length)) {
                            ...
                            if (displayData !== null && displayData.type === 1 /* Armature */) {
                                var armatureData_1 = this.getArmatureData(displayData.path, displayData.parent.parent.parent.name);
                                if (armatureData_1) {
                                    this.replaceAnimation(display, armatureData_1);
                                }
                            }
                        }
                    }
        ...
        BaseFactory.prototype.copyAnimationsToArmature = function (toArmature, fromArmatreName, fromSkinName, fromDragonBonesDataName, replaceOriginalAnimation) {
            ...
            return this.replaceAnimation(toArmature, armatureData);
        };
        /**
         * @private
         */
