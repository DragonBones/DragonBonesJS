namespace demosPixi {
    export namespace coreElement {
        ...
        export class Game {
            public static STATE_WIDTH: number = 0;
            ...
            private _init(): void {
                Game.STATE_WIDTH = this.renderer.width;
        ...
        class Mecha {
            ...
            public constructor() {
                ...
                this._armatureDisplay.x = Game.STATE_WIDTH * 0.5;
            ...
            private _updatePosition(): void {
                if (this._speedX != 0) {
                    ...
                    } else if (this._armatureDisplay.x > Game.STATE_WIDTH) {
                        this._armatureDisplay.x = Game.STATE_WIDTH;
                    }
                }
        ...
        class Bullet {
            ...
            public update(): Boolean {
                ...
                if (
                    this._armatureDisplay.x < -100 || this._armatureDisplay.x >= Game.STATE_WIDTH + 100 ||
