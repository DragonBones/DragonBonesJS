...
class EyeTracking extends BaseDemo {
    constructor() {
        ...
        this._resources.push("resource/shizuku/shizuku_ske.json", "resource/shizuku/shizuku.1024/texture_00.png", "resource/shizuku/shizuku.1024/texture_01.png", "resource/shizuku/shizuku.1024/texture_02.png", "resource/shizuku/shizuku.1024/texture_03.png");
    }
    _onStart() {
    ...
    _touchHandler(event) {
        this._setTarget(event.global.x, event.global.y);
    }
    _setTarget(x, y) {
