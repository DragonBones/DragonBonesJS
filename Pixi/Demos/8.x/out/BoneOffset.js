...
class BoneOffset extends BaseDemo {
    constructor() {
        super();
        this._resources.push("resource/bullet_01/bullet_01_ske.json", "resource/bullet_01/bullet_01_tex.json", "resource/bullet_01/bullet_01_tex.png");
    }
    _onStart() {
        const factory = dragonBones.PixiFactory.factory;
        factory.parseDragonBonesData(this._pixiResources["resource/bullet_01/bullet_01_ske.json"]);
        factory.parseTextureAtlasData(this._pixiResources["resource/bullet_01/bullet_01_tex.json"], this._pixiResources["resource/bullet_01/bullet_01_tex.png"]);
        for (let i = 0; i < 100; ++i) {
