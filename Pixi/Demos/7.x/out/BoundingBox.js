...
class BoundingBox extends BaseDemo {
    constructor() {
        super();
        this._helpPointA = new PIXI.Point();
        this._helpPointB = new PIXI.Point();
        this._helpPointC = new PIXI.Point();
        this._resources.push("resource/mecha_2903/mecha_2903_ske.json", "resource/mecha_2903/mecha_2903_tex.json", "resource/mecha_2903/mecha_2903_tex.png", "resource/bounding_box_tester/bounding_box_tester_ske.json", "resource/bounding_box_tester/bounding_box_tester_tex.json", "resource/bounding_box_tester/bounding_box_tester_tex.png");
    }
    _onStart() {
        //
        ...
        factory.parseTextureAtlasData(this._pixiResources["resource/bounding_box_tester/bounding_box_tester_tex.json"], this._pixiResources["resource/bounding_box_tester/bounding_box_tester_tex.png"]);
        //
        ...
        this._line.offsetMode = 2 /* dragonBones.OffsetMode.Override */;
        this._pointA.offsetMode = 2 /* dragonBones.OffsetMode.Override */;
        this._pointB.offsetMode = 2 /* dragonBones.OffsetMode.Override */;
        ...
        DragHelper.getInstance().stage = this.stage;
