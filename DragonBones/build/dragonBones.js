    ...
    var DataParser = (function () {
        ...
        DataParser.prototype._globalToLocal = function (armature) {
            ...
            for (var i in armature.animations) {
                ...
                for (var i_1 in timelines) {
                    var timeline = timelines[i_1];
                    if (timeline.bone.parent) {
                        var parentTimeline = animation.getBoneTimeline(timeline.bone.parent.name);
                        for (var i_2 = 0, l = timeline.frames.length; i_2 < l; ++i_2) {
                    ...
                    for (var i_3 = 0, l = timeline.frames.length; i_3 < l; ++i_3) {
        ...
        AnimationTimelineState.prototype._onCrossFrame = function (frame) {
            ...
            for (var i = 0, l = actions.length; i < l; ++i) {
                ...
                if (actionData.slot) {
                    ...
                    var slots = this._armature.getSlots();
                    for (var i_4 = 0, l_1 = slots.length; i_4 < l_1; ++i_4) {
    ...
    var Armature = (function (_super) {
        ...
        Armature.prototype.advanceTime = function (passedTime) {
            ...
            if (this._delayDispose) {
                ...
                var delayAdvanceTime = this._delayAdvanceTime;
                this._delayAdvanceTime = -1;
            ...
            if (this._fillBuildArmaturePackage(fromDragonBonesDataName, fromArmatreName, fromSkinName, dataPackage)) {
                ...
                if (dataPackage.skin) {
                    ...
                    for (var i = 0, l = slots.length; i < l; ++i) {
                        ...
                        for (var i_6 = 0, l_2 = toSlotDisplayList.length; i_6 < l_2; ++i_6) {
    ...
    var ObjectDataParser = (function (_super) {
        ...
        ObjectDataParser.prototype._parseTweenFrame = function (rawData, frame, frameStart, frameCount) {
            ...
            if (ObjectDataParser.TWEEN_EASING in rawData) {
                ...
                if (this._animation.scale == 1 && this._timeline.scale == 1 && frame.duration * this._armature.frameRate < 2) {
