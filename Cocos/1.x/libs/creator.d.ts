...
declare module dragonBonesOLD {	
	...
	export class ArmatureDisplay extends cc._RendererUnderSG {		
		...
		*/
		playAnimation(animName: string, playTimes: number): dragonBonesOLD.AnimationState;		
		/**
		!#en
		...
		*/
		...
		@param target target 
		*/
		addEventListener(eventType: dragonBonesOLD.EventObject, listener: Function, target: any): void;		
		/**
		!#en
		...
		@param target target 
		*/
		removeEventListener(eventType: dragonBonesOLD.EventObject, listener: Function, target: any): void;		
		/**
		!#en
		...
		@param armatureName armatureName 
		*/
		buildArmature(armatureName: string): dragonBonesOLD.Armature;		
		/**
		!#en
	...
	/** !#en The skeleton data of dragonBonesOLD.
	!#zh dragonBonesOLD 的 骨骼数据。 */
	...
	/** !#en The skeleton atlas data of dragonBonesOLD.
	!#zh dragonBonesOLD 的骨骼纹理数据。 */
...
declare namespace dragonBonesOLD {
    /**
     * @private
     */
...
declare namespace dragonBonesOLD {
     ...
     * @language zh_CN
     * 动画混合时，使用的淡出方式。
     * @see dragonBonesOLD.Animation#fadeIn()
     * @version DragonBones 4.5
     */
     ...
     * @see dragonBonesOLD.WorldClock
     * @see dragonBonesOLD.Armature
     ...
     * @see dragonBonesOLD.AnimationData
     * @see dragonBonesOLD.AnimationState
     * @version DragonBones 3.0
     */
    class Animation extends BaseObject {
         ...
         * @returns 返回控制这个动画数据的动画状态。
         * @see dragonBonesOLD.AnimationFadeOutMode
         * @see dragonBonesOLD.AnimationState
         * @version DragonBones 4.5
         */
...
declare namespace dragonBonesOLD {
    ...
    class AnimationState extends BaseObject {
         ...
         * @see dragonBonesOLD.Slot#displayController
         * @version DragonBones 3.0
         */
         ...
         * @language zh_CN
         * 动画名称。
         * @see dragonBonesOLD.AnimationData#name
         * @version DragonBones 3.0
         */
        name: string;
        /**
...
declare namespace dragonBonesOLD {
     ...
     * @see dragonBonesOLD.IAnimatable
     * @see dragonBonesOLD.Armature
     * @version DragonBones 3.0
     */
...
declare namespace dragonBonesOLD {
     ...
     * @see dragonBonesOLD.ArmatureData
     * @see dragonBonesOLD.Bone
     * @see dragonBonesOLD.Slot
     * @see dragonBonesOLD.Animation
     * @see dragonBonesOLD.IArmatureDisplay
     * @version DragonBones 3.0
     */
    class Armature extends BaseObject implements IAnimateble {
         ...
         * @see dragonBonesOLD.IAnimateble
         * @see dragonBonesOLD.WorldClock
         * @see dragonBonesOLD.IArmatureDisplay
         * @version DragonBones 3.0
         */
         ...
         * @language zh_CN
         * 骨架名称。
         * @see dragonBonesOLD.ArmatureData#name
         * @version DragonBones 3.0
         */
        name: string;
        /**
         ...
         * @see dragonBonesOLD.DragonBonesData#frameRate
         * @see dragonBonesOLD.ArmatureData#frameRate
         * @version DragonBones 4.5
         */
...
declare namespace dragonBonesOLD {
    ...
    class Bone extends TransformObject {
         ...
         * 是否包含某个指定的骨骼或插槽。
         * @returns [true: 包含，false: 不包含]
         * @see dragonBonesOLD.TransformObject
         * @version DragonBones 3.0
         */
        ...
        /**
         * @deprecated
         * @see dragonBonesOLD.Armature#getSlot()
         */
        slot: Slot;
    }
}
declare namespace dragonBonesOLD {
     ...
     * @language zh_CN
     * 骨架显示容器和事件的接口。
     * @see dragonBonesOLD.Armature#display
     * @version DragonBones 4.5
     */
...
declare namespace dragonBonesOLD {
    ...
    abstract class Slot extends TransformObject {
         ...
         * @default null
         * @see dragonBonesOLD.AnimationState#displayControl
         * @see dragonBonesOLD.AnimationState#name
         * @see dragonBonesOLD.AnimationState#group
         * @version DragonBones 4.5
         */
...
declare namespace dragonBonesOLD {
    ...
    class ArmatureData extends BaseObject {
         ...
         * @language zh_CN
         * 骨架类型。
         * @see dragonBonesOLD.ArmatureType
         * @version DragonBones 3.0
         */
        type: ArmatureType;
        /**
...
declare namespace dragonBonesOLD {
    ...
    class DragonBonesData extends BaseObject {
        ...
        /**
         * @deprecated
         * @see dragonBonesOLD.BaseFactory#removeDragonBonesData()
         */
        dispose(): void;
    }
}
...
declare namespace dragonBonesOLD {
    ...
    abstract class DataParser {
        ...
        /**
         * @deprecated
         * @see dragonBonesOLD.BaseFactory#parseDragonBonesData()
         */
        static parseDragonBonesData(rawData: any): DragonBonesData;
        /**
         * @deprecated
         * @see dragonBonesOLD.BaseFactory#parsetTextureAtlasData()
         */
...
declare namespace dragonBonesOLD {
     ...
     * @see dragonBonesOLD.DragonBonesData
     * @see dragonBonesOLD.TextureAtlasData
     * @see dragonBonesOLD.ArmatureData
     * @see dragonBonesOLD.Armature
     * @version DragonBones 3.0
     */
    abstract class BaseFactory {
         ...
         * @see dragonBonesOLD.DragonBonesData#autoSearch
         * @see dragonBonesOLD.TextureAtlasData#autoSearch
         * @version DragonBones 4.5
         */
        autoSearch: boolean;
        /**
         ...
         * @see #addTextureAtlasData()
         * @see #removeTextureAtlasData()
         * @see dragonBonesOLD.textures.TextureAtlasData
         * @version DragonBones 3.0
         */
