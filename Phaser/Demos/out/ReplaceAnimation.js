...
var ReplaceAnimation = /** @class */ (function (_super) {
    ...
    ReplaceAnimation.prototype._onStart = function () {
        ...
        factory.parseTextureAtlasData(this.game.cache.getItem("resource/assets/core_element/mecha_2903_tex.json", Phaser.Cache.JSON).data, this.game.cache.getImage("resource/assets/core_element/mecha_2903_tex.png", true).base);
        //
